...
void ReadTemp_Task(void *pvParameter) 
{
    ...
    while(1)
    {
        //readTemperature_Thermister();
        readTemperature_AH10_1();
        readTemperature_ESP32();
...
void readTemperature_AH10_1(void)
{
    ...
    if (readStatus != AHT10_ERROR)
    {
        ...
        #ifdef PRINTDATA
        Serial.print(F("Temperature AH10_1: "));
        Serial.print(temperature_AH_1);
        Serial.print(F("    Humidity AH10_1: "));
        Serial.println(humitity_AH_1);
        #endif // PRINTDATA
    }
    else
    {
